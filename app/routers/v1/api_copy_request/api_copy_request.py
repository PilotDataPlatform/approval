...
from app.commons.meta_services import bulk_get_by_ids, get_files_recursive, get_node_by_id
...
class APICopyRequest:
    ...
    @router.post("/request/copy/{project_code}", tags=[_API_TAG], response_model=POSTRequestResponse,
    ...
    @router.get("/request/copy/{project_code}", tags=[_API_TAG], response_model=GETRequestResponse,
            summary="Create a copy request")
    ...
    @router.get("/request/copy/{project_code}/files", tags=[_API_TAG], response_model=GETRequestFilesResponse,
    ...
    def list_request_files(self, project_code: str, params: GETRequestFiles = Depends(GETRequestFiles)):
        ...
        if params.parent_id:
            ...
            while entity_id:
                file = db.session.query(EntityModel).filter_by(request_id=params.request_id, entity_id=entity_id).first()
                if file:
    ...
    @router.put("/request/copy/{project_code}/files", tags=[_API_TAG], response_model=PUTRequestFilesResponse,
    ...
    @router.patch("/request/copy/{project_code}/files", tags=[_API_TAG], response_model=PUTRequestFilesResponse,
    ...
    @router.put("/request/copy/{project_code}", tags=[_API_TAG], response_model=PUTRequestFilesResponse,
    ...
    @router.get("/request/copy/{project_code}/pending-files", tags=[_API_TAG], response_model=GETPendingResponse,
